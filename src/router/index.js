...
import { experiences, formation, hobbies } from "../constants/constants";
...
const router = createRouter({
  ...
  routes: [
    ...
    },
    {
      ...
      name: "projets",
      component: ParcoursSectionView,
      props: { title: "Projets", contents: [], isProjectTabActive: true },
    },
    {
      path: "/hobbies",
      name: "hobbies",
      component: ParcoursSectionView,
      props: { title: "Hobbies", contents: hobbies, isHobbiesTabActive: true},
    },
  ],
});
