export default function getPresentationText() {
  return `<p>Je suis <span class="green">Développeur Fullstack Spring Boot - Angular</span> chez <span>Apside TOP</span> depuis Décembre 2019.</p>
